...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_LineChart_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_LineChart_t qt_meta_stringdata_LineChart = {
    {
QT_MOC_LITERAL(0, 9) // "LineChart"
...
const QMetaObject LineChart::staticMetaObject = { {
    ...
    qt_meta_stringdata_LineChart.offsetsAndSize,
    qt_meta_data_LineChart,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_LineChart_t
, QtPrivate::TypeAndForceComplete<LineChart, std::true_type>
